...
public class Mkoba_Transactions {

     private String Recipient_No,Dead_line,Description, User_ID, Mkoba_ID, Category,Payment_Id,
             Payment_Title,Trans_UID,Trans_Name,Trans_Phone;
    ...
    public Mkoba_Transactions() {
        //Empty...
    }


    public Mkoba_Transactions(String recipient_No, String dead_line, String description, String user_ID, String mkoba_ID, String category, String payment_Id, String payment_Title, String trans_UID, String trans_Name, String trans_Phone, double amount,
                              double total_price, int status_percent, int payment_status, int status, int count, Date timestamp) {
